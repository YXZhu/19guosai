...
#define i2c_write   i2c1Write
#define i2c_read    i2c1Read 
#define delay_ms    mpu_delay
#define get_ms      mpu_get_tick_count
...
//	
//}
extern void mpu_delay(uint32_t millisec);
extern int mpu_get_tick_count(unsigned long *count);
extern void rtt_printf(const char * sFormat, ...);
extern int i2c1Write(uint8_t addr, uint8_t reg, uint8_t len, uint8_t *data);
extern int i2c1Read(uint8_t addr, uint8_t reg, uint8_t len, uint8_t *buf);
